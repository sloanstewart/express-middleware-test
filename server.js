...
function gateKeeper(req, res, next) {
  ...
  console.log('gateKeeper START');
  const header = req.get('x-username-and-password');
  console.log('header is: '+header);
  
  const userInfo = queryString.parse(header);
  console.log('name: ' +userInfo.user + '\npass: ' + userInfo.pass);
  console.log(typeof userInfo.user);
  ...
  console.log('req.user is now: '+ userInfo.user);
  console.log('gateKeeper END');
  next();
}
